...
struct Constants {
    ...
    static let showSearchResultPageForHome = Notification.Name("showSearchResultPageForHome")
    static let showSearchResultPageForHeadline = Notification.Name("showSearchResultPageForHeadline")
    ...
    static let backendUrl = "http://ec2-user@ec2-54-67-49-43.us-west-1.compute.amazonaws.com:5000/"
//    static let backendUrl = "http://localhost:5000/"
    ...
    static let searchPlaceholder = "Enter keyword.."
}
